...
gemma -g ../../processed_data/project_genotype_file.bimbam -p ../../processed_data/project_imputed_phenotype_file.bimbam -a ../../processed_data/BXD_snps.txt -gk 1 -o bxd_relatedness
