...
class Columns2Clustering(ModellingBirch):
    ...
    def perform_birch(self, reduced_features_valid, n_clusters=10):
        ...
        birch_clustering=Pipeline([('preprocessing_qtl', preprocessing_qtl), ('birch', Birch(n_clusters=sorted_n_cluster_sil[0][0]))]) # reperform clustering with the best number of clusters
