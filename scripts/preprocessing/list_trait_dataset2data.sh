...
for i in {1..19544}; do
	...
	echo Trait id: ${trait_id} >> ../../processed_data/json_files/phenotype_file_${trait_id}_${dataset_id}.json
        echo Dataset id : ${dataset_id} >> ../../processed_data/json_files/phenotype_file_${trait_id}_${dataset_id}.json
	curl https://genenetwork.org/api/v_pre1/sample_data/${dataset_id}/${trait_id} >> ../../processed_data/json_files/phenotype_file_${trait_id}_${dataset_id}.json
done
