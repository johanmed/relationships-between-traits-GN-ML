...
fig.savefig('../../output/Results_analysis_learning_data1.png', dpi=500)
...
sorted_count_traits.plot.bar(ax=ax, color='black', alpha=0.7, legend=False) # plot number of hits for traits
...
fig.savefig('../../output/Total_number_hits_traits.png', dpi=500)
